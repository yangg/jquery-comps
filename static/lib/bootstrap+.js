$(function() {
  ...
  $.modal = function (option, _relatedTarget) {
    ...
    if (!option.target) {
      var targetHtml = '<div class="modal fade"><div class="modal-dialog"><div class="modal-content"><div class="text-muted text-center" style="padding: 3em 0"><i class="fa fa-refresh fa-spin"></i> Loading...</div></div></div></div>';
